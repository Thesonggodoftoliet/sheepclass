...
<div class="checkout-page">
    <div class="container">
        ...
        <ul class="default-links">
            <li>没有账号 ？ <a href="#">点击这里注册，加入我们吧</a></li>
        </ul>
        ...
        <div class="row clearfix">
            <div class="col-md-7 col-sm-12 col-xs-12">
                ...
                <div class="billing-details">
                    ...
                    <div class="shop-form">
                        <form method="post" action=""  onsubmit="return submit_judge()">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <div class="field-label"> 手机号/邮箱 <sup>*</sup>
                                    <input type="text" name="usenumber" value="" placeholder="" id="input_usernumber">
                                    </div>
                                    <div class="field-label" id="alert_usernumber"></div>
                                </div>

                                <!--Form Group-->
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <div class="field-label"> 密 码<sup>*</sup>
                                    <input type="text" name="password" value="" placeholder="" id="input_password"></div>
                                    <div class="field-label" id="alert_password"></div>
                                </div>
                               <button type="submit" class="theme-btn btn-style-one" style="margin-left:200px">   确  定 <span class="fa fa-long-arrow-right" ></span></button>
                            </div>
                        </form>
    ...
    <script src="../assets/bootstrap-touch-spin/jquery.bootstrap-touchspin.css"></script>
    ...
    <script src="common_login.js" defer="true"></script>
</div>
</body>
</html>
