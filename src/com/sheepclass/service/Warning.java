...
public class Warning {
    ...
    private String myEmailAccount = "1822014233@qq.com";
    private String myEmailPassword = "sskojlarbnjjegjd";
    ...
    public MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,int port,String username) throws Exception {
        ...
        message.setSubject("学习提醒", "UTF-8");

        // 5. Content: 邮件正文（可以使用html标签）（内容有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改发送内容）
        message.setContent("家长您好，您的孩子已七天未上线学习，请及时督促。", "text/html;charset=UTF-8");
